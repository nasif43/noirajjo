noirajjo
A fork of yggdrasil-network/yggdrasil-go, modified for use in Bangladesh.
Background
...
bashgit clone https://github.com/nasif43/noirajjo
cd noirajjo
./build
...
Run:
bash./yggdrasil -useconffile yggdrasil.conf
Your node will get a stable IPv6 address and can reach any other Yggdrasil/noirajjo node it can find peers to.
Original project
All credit for the underlying implementation goes to the Yggdrasil Network team. This fork exists for a specific geographic and political context. If you're outside Bangladesh, the original repo is what you want.
